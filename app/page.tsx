...
import ArrayMethodsExplorer from "@/components/array-methods-explorer"
        ...
        <header className="mb-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="outline" size="icon" asChild>
              <Link href="https://github.com/DevTwitter/js-array-methods">
              ...
              <div className="bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-6 shadow-sm">
                ...
                <div className="flex gap-2">
                  ...
                  <Button asChild variant="outline" className="flex-1">
                    <Link href="https://github.com/DevTwitter/js-string-methods" target="_blank" rel="noopener noreferrer">
