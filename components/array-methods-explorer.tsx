...
import { arrayMethods } from "@/lib/array-methods"
...
export default function ArrayMethodsExplorer() {
  const { t } = useI18n()
  const [selectedMethod, setSelectedMethod] = useState(arrayMethods[0])
  ...
  const categories = [
    ...
    { key: "iteration", ...t.categories.iteration },
    { key: "conversion", ...t.categories.conversion },
  ]
